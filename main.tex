...
\IfFileExists{build/default/test_output.tex}{%
  \section{Test}
  \input{build/default/test_output.tex}
}{%
  \section{No test output found.}
}%



\section{Flow}
\input{commute_output}
...
\begin{align}
  \Delta_\mathrm{SC}(\mathbf{p}) &= 2 \sum_{\mathbf{q}} U_{\uparrow \downarrow} (\mathbf{p}, \mathbf{-p}, \mathbf{q} - \mathbf{p}; \ell_0) \langle f_{\mathbf{q}} \rangle \\
...
\begin{equation}
  ...
  = \begin{pmatrix}
        ...
        -\braket{f_{\mathbf{p}}^\dagger} & 0 & \braket{n_{-\mathbf{p},\downarrow}} & \braket{g_{-\mathbf{p},\downarrow}} \\
